...
template <>
KOKKOS_FUNCTION double ManufacturedRHS<CurvilinearSolution<CzarnyToCartesian<R, Theta, X, Y>>>::
...
template class ManufacturedRHS<CurvilinearSolution<CzarnyToCartesian<R, Theta, X, Y>>>;
