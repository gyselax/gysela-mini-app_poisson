...
template <>
KOKKOS_FUNCTION double ManufacturedRHS<CartesianSolution<CircularToCartesian<R, Theta, X, Y>>>::
...
template class ManufacturedRHS<CartesianSolution<CircularToCartesian<R, Theta, X, Y>>>;
