...
ManufacturedRHS<CartesianSolution<CzarnyToCartesian<R, Theta, X, Y>>>::
...
ManufacturedRHS<CartesianSolution<CzarnyToCartesian<R, Theta, X, Y>>>::
    ...
    return 0.4096 * minus_pow_6 * plus_pow_6 * coeff_alpha *
               Kokkos::sin(2.0 * M_PI * e * r * sin_theta * xi /
                           ((2.0 - tmp1))) *
           ...
           ((-r) *
                ...
                (0.4096 * minus_pow_6 * plus_pow_6 *
                     ((-2.0) * M_PI * e * epsilon * r * ipow(sin_theta, 2) *
                          xi / (ipow(2.0 - tmp1, 2) * tmp1) +
                      2.0 * M_PI * e * cos_theta * xi / ((2.0 - tmp1))) *
                     Kokkos::cos(2.0 * M_PI * (1.0 - tmp1) / epsilon) *
                     Kokkos::cos(2.0 * M_PI * e * r * sin_theta * xi /
                                 ((2.0 - tmp1))) -
                         ...
                         (Kokkos::pow((e * epsilon * r * sin_theta * cos_theta *
                          ...
                          ipow(cos_theta, 2) /
                              (epsilon * (epsilon + 2.0 * r * cos_theta) +
                               1.0))),
                    (3.0 / 2.0)) -
            r * (((-e) * epsilon * r * ipow(sin_theta, 2) * xi / (ipow(2.0 - tmp1, 2) * tmp1) + e * cos_theta * xi / ((2.0 - tmp1))) * (e * epsilon * r * sin_theta * cos_theta * xi / (ipow(2.0 - tmp1, 2) * tmp1) + e * sin_theta * xi / ((2.0 - tmp1))) - sin_theta * cos_theta / (epsilon * (epsilon + 2.0 * r * cos_theta) + 1.0)) *
                (0.8192 * M_PI * epsilon * minus_pow_6 * plus_pow_6 *
                 ...
                 0.4096 * minus_pow_6 * plus_pow_6 *
                     ((-2.0) * M_PI * e * epsilon * r * ipow(sin_theta, 2) *
                          xi / (ipow(2.0 - tmp1, 2) * tmp1) +
                      2.0 * M_PI * e * cos_theta * xi / ((2.0 - tmp1))) *
                     (2.0 * M_PI * e * epsilon * r * sin_theta * cos_theta *
                          xi / (ipow(2.0 - tmp1, 2) * tmp1) +
                     ...
                     ipow(sin_theta, 2) /
                        ...
                        (Kokkos::pow((e * epsilon * r * sin_theta * cos_theta *
                         ...
                         ipow(cos_theta, 2) /
                             (epsilon * (epsilon + 2.0 * r * cos_theta) +
                              1.0))) +
            r * ((-2.0) * epsilon * ipow(sin_theta, 2) * cos_theta / Kokkos::pow((epsilon * (epsilon + 2.0 * r * cos_theta) + 1.0), 2.0) + ((-e) * epsilon * r * ipow(sin_theta, 2) * xi / (ipow(2.0 - tmp1, 2) * tmp1) + e * cos_theta * xi / ((2.0 - tmp1))) * (2.0 * e * (epsilon * epsilon) * r * ipow(sin_theta, 2) * cos_theta * xi / (ipow(2.0 - tmp1, 2) * Kokkos::pow((epsilon * (epsilon + 2.0 * r * cos_theta) + 1.0), (3.0 / 2.0))) - 4.0 * e * (epsilon * epsilon) * r * ipow(sin_theta, 2) * cos_theta * xi / (ipow(2.0 - tmp1, 3) * (epsilon * (epsilon + 2.0 * r * cos_theta) + 1.0)) - 2.0 * e * epsilon * ipow(sin_theta, 2) * xi / (ipow(2.0 - tmp1, 2) * tmp1) + 2.0 * e * epsilon * ipow(cos_theta, 2) * xi / (ipow(2.0 - tmp1, 2) * tmp1))) *
                (0.4096 * minus_pow_6 * plus_pow_6 *
                     (2.0 * M_PI * e * epsilon * r * sin_theta * cos_theta *
                          xi / (ipow(2.0 - tmp1, 2) * tmp1) +
                      2.0 * M_PI * e * sin_theta * xi / ((2.0 - tmp1))) *
                     ...
                     ipow(sin_theta, 2) /
                        ...
                        (Kokkos::pow((e * epsilon * r * sin_theta * cos_theta *
                         ...
                         ipow(cos_theta, 2) /
                             (epsilon * (epsilon + 2.0 * r * cos_theta) +
                              1.0))) -
            r * (0.4096 * minus_pow_6 * plus_pow_6 * ((-2.0) * M_PI * e * epsilon * r * ipow(sin_theta, 2) * xi / (ipow(2.0 - tmp1, 2) * tmp1) + 2.0 * M_PI * e * cos_theta * xi / ((2.0 - tmp1))) * Kokkos::cos(2.0 * M_PI * (1.0 - tmp1) / epsilon) * Kokkos::cos(2.0 * M_PI * e * r * sin_theta * xi / ((2.0 - tmp1))) - 0.8192 * M_PI * minus_pow_6 * plus_pow_6 * sin_theta * Kokkos::sin(2.0 * M_PI * (1.0 - tmp1) / epsilon) * Kokkos::sin(2.0 * M_PI * e * r * sin_theta * xi / ((2.0 - tmp1))) / tmp1) *
                     ...
                     ipow(sin_theta, 2) /
                        ...
                        (Kokkos::pow((e * epsilon * r * sin_theta * cos_theta *
                         ...
                         ipow(cos_theta, 2) /
                             (epsilon * (epsilon + 2.0 * r * cos_theta) +
                              1.0))) +
            r * (Kokkos::pow(((-e) * epsilon * r * ipow(sin_theta, 2) * xi / (ipow(2.0 - tmp1, 2) * tmp1) + e * cos_theta * xi / ((2.0 - tmp1))), 2.0) + ipow(sin_theta, 2) / (epsilon * (epsilon + 2.0 * r * cos_theta) + 1.0)) *
             ...
             sin_theta * cos_theta /
                ...
                (0.8192 * M_PI * epsilon * r * minus_pow_6 * plus_pow_6 *
                 ...
                 2.4576 * r * minus_pow_6 * ipow(r + 1.0, 5) *
                     ...
                     Kokkos::cos(2.0 * M_PI * e * r * sin_theta * xi /
                                 ((2.0 - tmp1))) -
                 4.9152 * M_PI * r * minus_pow_6 * ipow(r + 1.0, 5) *
                     sin_theta *
                     Kokkos::sin(2.0 * M_PI * (1.0 - tmp1) / epsilon) *
                     Kokkos::sin(2.0 * M_PI * e * r * sin_theta * xi /
                                 ((2.0 - tmp1))) /
                          ...
                          ((-2.0) * e * (epsilon * epsilon) * (r * r) *
                           ...
                           4.0 * e * (epsilon * epsilon) * (r * r) *
                               ...
                               (ipow(2.0 - tmp1, 3) *
                                (epsilon * (epsilon + 2.0 * r * cos_theta) +
                                 1.0)) -
                           6.0 * e * epsilon * r * sin_theta * cos_theta * xi /
                               (ipow(2.0 - tmp1, 2) * tmp1) -
                 ...
                 0.4096 * minus_pow_6 * plus_pow_6 *
                     ((-2.0) * M_PI * e * (epsilon * epsilon) * (r * r) *
                      ...
                      4.0 * M_PI * e * (epsilon * epsilon) * (r * r) *
                          ...
                          (ipow(2.0 - tmp1, 3) *
                           (epsilon * (epsilon + 2.0 * r * cos_theta) + 1.0)) -
                      6.0 * M_PI * e * epsilon * r * sin_theta * cos_theta *
                          xi / (ipow(2.0 - tmp1, 2) * tmp1) -
                      2.0 * M_PI * e * sin_theta * xi / ((2.0 - tmp1))) *
                     Kokkos::cos(2.0 * M_PI * (1.0 - tmp1) / epsilon) *
                     Kokkos::cos(2.0 * M_PI * e * r * sin_theta * xi /
...
template class ManufacturedRHS<
    CartesianSolution<CzarnyToCartesian<R, Theta, X, Y>>>;
